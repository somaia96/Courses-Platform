...
const HeroSection = () => {
    ...
    return (
        <div className="flex py-10 flex-col rounded-2xl shadow-lg h-full lg:flex-row bg-white/20">
            <div className='flex-1 gap-5 flex flex-col justify-center items-center lg:items-start lg:pl-28 text-start space-y-5'>
