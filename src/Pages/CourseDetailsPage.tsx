...
const CourseDetailsPage = () => {
    ...
    return (<div className="text-gray-900 space-y-5">
        <h2 className="text-black font-semibold text-5xl flex gap-3 items-center">{course.title} <GraduationCap size={50} /></h2>
        <p className="w-1/2">{course.fullDescription}</p>
